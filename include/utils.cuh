...
const char* get_kernel_name(int kernel_choice) {
  switch (kernel_choice) {
    ...
    case 20: return "ESMM Combined A+B Sparsity (Optimized - Conditional Loading)";
    case 21: return "ESMM Combined V2";
